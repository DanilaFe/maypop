...
>         , Constructor { cParams = [ (Ind nat, Explicit) ], cIndices = [], cName = "S" }
>         ]
>     }
...
>     , iName = "Fin"
>     , iConstructors =
>         [ Constructor { cParams = [ (Ind nat, Explicit) ], cIndices = [ s (Ref 0) ], cName = "FZ" }
>         , Constructor { cParams = [ (Ind nat, Explicit), (App (Ind fin) (Ref 0), Explicit) ], cIndices = [ App (Constr nat 1) (Ref 1) ], cName = "FS" }
>         ]
>     }
...
> either_ :: Inductive
> either_ = Inductive
>     { iParams = [(t 0, Explicit), (t 0, Explicit)]
>     , iArity = []
>     , iSort = Type 0
>     , iName = "Either"
>     , iConstructors =
>         [ Constructor { cParams = [(Ref 1, Explicit)], cIndices = [], cName = "Left" }
>         , Constructor { cParams = [(Ref 0, Explicit)], cIndices = [], cName = "Right" }
>         ]
>     }
...
>     , iName = "Pair"
>     , iConstructors =
>         [ Constructor { cParams = [(Ref 1, Explicit), (Ref 1, Explicit)], cIndices = [], cName = "MkPair" }
>         ]
>     }
...
>     , iName = "Countable"
>     , iConstructors =
>         [ Constructor { cParams = [(t 0, Explicit), (Ref 0, Explicit), (Prod (Ref 1) (Ind nat), Explicit)], cIndices = [], cName = "Wrap" }
>         ]
>     }
...
>     $ Map.fromList [("ℕ", Definition Public $ IndDef nat), ("pred", Definition Public $ FunDef (Function "pred" [(Ind nat, Explicit)] (Ind nat) pred_ Nothing))]
